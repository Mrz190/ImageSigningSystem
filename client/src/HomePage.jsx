    ...
    <div>
      ...
      <div className="global-container">
        <div className="upload-container">
          <form onSubmit={handleSubmit} method="POST" encType="multipart/form-data">
            <div className="fileform-container">
              ...
              />
              <label className="file-label" htmlFor="actual-btn">Choose File</label>
              <span className="chosen-image" id="file-chosen">{file ? file.name : "No file chosen"}</span>
        ...
        <div className="images-container">
          {loading ? <div className="loading">Loading...</div> : <Images refreshImages={refreshImages} />}
        </div>
      </div>
